...
async def goal(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Timezone keyboard
    timezone_keyboard = [
        [KeyboardButton("UTC+1"), KeyboardButton("UTC+2"), KeyboardButton("UTC+3")],
        [KeyboardButton("UTC+4"), KeyboardButton("UTC+5"), KeyboardButton("UTC+6")],
        [KeyboardButton("UTC+7"), KeyboardButton("UTC+8"), KeyboardButton("UTC+9")],
        [KeyboardButton("UTC+10"), KeyboardButton("UTC+11"), KeyboardButton("UTC+12")],
